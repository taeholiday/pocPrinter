...
import 'package:testprintsunmi/syncfusion_flutter_barcodes/SfBarcodeGenerator.dart';
import 'package:testprintsunmi/rececipt/rececipt.dart';
      ...
      body: Center(
        child: Column(
          children: <Widget>[
            ...
            RaisedButton(
              onPressed: () {
                Navigator.pushNamed(context, Routes.barcodeImage);
              },
